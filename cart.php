                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-item" data-title="Product">
                                            ...
                                            <a href="#"><img width="180" height="180" src="images/products/1.png" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="product-women-01" srcset="" sizes="(max-width: 180px) 100vw, 180px"></a><a class="product-discrp" href="">Oppo F3 (Black,64 GB) (4GB RAM)</a></td>

                                        <td class="product-price" data-title="Price">
                                            <span class="woocommerce-Price-amount amount">21.00<span class="woocommerce-Price-currencySymbol">$</span></span>					</td>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity" data-title="Quantity">
                                            <div class="quantity">
                                                <input type="number" step="1" min="1" max="15" name="cart[3cec07e9ba5f5bb252d13f5f431e4bbb][qty]" value="1" title="Qty" class="input-text qty text" size="4" pattern="[0-9]*" inputmode="numeric">
                                            </div>
                                        </td>
                                        ...
                                        <div class="total-wrap">
                                            <table cellspacing="0" class="shop_table shop_table_responsive">
                                                ...
                                                <tbody><tr class="cart-subtotal">
                                                        <th>Subtotal</th>
                                                        <td data-title="Subtotal"><span class="woocommerce-Price-amount amount">42.00<span class="woocommerce-Price-currencySymbol">$</span></span></td>
                                                    </tr>

                                                    <tr class="order-total">
                                                        <th>Grand Total</th>
                                                        <td data-title="Total"><strong><span class="woocommerce-Price-amount amount">42.00<span class="woocommerce-Price-currencySymbol">$</span></span></strong> </td>
                                                    </tr>
