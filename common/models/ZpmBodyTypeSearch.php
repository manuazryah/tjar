...
/**
 * ZpmBodyTypeSearch represents the model behind the search form about `common\models\ZpmBodyType`.
 */
class ZpmBodyTypeSearch extends ZpmBodyType {
