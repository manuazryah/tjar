...
/**
 * ZpmScreenSizeSearch represents the model behind the search form about `common\models\ZpmScreenSize`.
 */
class ZpmScreenSizeSearch extends ZpmScreenSize {
	...
	public function rules() {
		return [
			...
			[['value', 'field1', 'canonical_name', 'field2', 'field3', 'DOC', 'DOU'], 'safe'],
		];
	}
