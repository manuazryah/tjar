...
/**
 * ZpmProcessorSearch represents the model behind the search form about `common\models\ZpmProcessor`.
 */
class ZpmProcessorSearch extends ZpmProcessor
{
    /**
     * @inheritdoc
     */
