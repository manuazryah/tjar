                                   ...
                                   $commission = OrderDetails::commission($orderdetails);
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="order-total">
                                            <th>Grand Total</th>
                                            <td data-title="Total"><strong><span class="woocommerce-Price-amount amount grand_total"><?= sprintf("%0.2f", $grand); ?><span class="woocommerce-Price-currencySymbol"> AED</span></span></strong> </td>
                                        </tr>
                                        <tr class="commission">
                                            <th>Commission</th>
                                            <td data-title="Commission"><span class="woocommerce-Price-amount amount"><spn class="promotion_discount"></spn><?= sprintf("%0.2f", $commission); ?><span class="woocommerce-Price-currencySymbol"> AED</span> (For Full fill products)</span></td>
                                        </tr>
