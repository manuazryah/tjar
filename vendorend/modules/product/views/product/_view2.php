...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 product-div">
        <div class="album-image">
                <a href="#" class="thumb" data-action="edit">
                        <img src="<?= Yii::$app->homeUrl . '../uploads/products/' . Yii::$app->UploadFile->folderName(0, 1000, $model->id) . '/' . $model->id . '/profile/' . $model->canonical_name . '_thumb.' . $model->gallery_images; ?>" class="img-responsive">
                </a>
                <div>
