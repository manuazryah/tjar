...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 product-div">
        <div class="album-image">
				...
				if (file_exists($product_image)) {
					?>
					<img src="<?= Yii::$app->homeUrl . '../uploads/products/' . Yii::$app->UploadFile->folderName(0, 1000, $model->id) . '/' . $model->id . '/profile/' . $model->canonical_name . '_medium' . '.' . $model->gallery_images ?>" class="img-responsive img_list">
