                                ...
                                <div class="sidebar-menu-inner">
                                        ...
                                        <ul id="main-menu" class="main-menu">
                                                ...
                                                <li class="">
                                                        ...
                                                        <ul>
                                                                <li>
                                                                        <?= Html::a('Inventory Management', ['/product/product/index?vendor_status=1'], ['class' => 'title']) ?>
                                                                </li>
                                                ...
                                                <li class="">
                                                        ...
                                                        <ul>
                                                                <li>
                                                                        <?= Html::a('Inventory', ['/product/fullfill/index?vendor_status=1'], ['class' => 'title']) ?>
                                                                </li>
                                                ...
                                                <li>
                                                        ...
                                                        <ul>
                                                                <li>
                                                                        <?= Html::a('Stock report', ['/stock/stock-history/index'], ['class' => 'title']) ?>
                                                                </li>
                                                        </ul>
                                                </li>
