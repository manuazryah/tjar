                                        ...
                                        <div class="edit-account">
                                                <div class="personal-info marg-btm-20">
                                                        <div class="personal-info-head marg-btm-20">
                                                                ...
                                                                <span class="info-link" id="pinfo-edit">
                                                                        <button class="btn edit-btn-new btn-xs">
                                                                                <i class="fa fa-pencil"></i>
                                                                                <span>Edit</span>
                                                                        </button>
                                                                </span>
                                                                <span class="info-link" id="pinfo-cancel">
                                                                        <button class="btn cancel-btn-new btn-xs">
                                                                                <span>Cancel</span>
                                                                        </button>
                                                                </span>
                                                        </div>
                                                                ...
                                                                <fieldset>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padlft0">
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padlft0">
                                                                                        <?php
                                                                                        echo '<label class="control-label" for="orderdetailssearch-createdTo" style="color:black">Date Of Birth</label>';
...
//            'form' => $form,
                                                ...
                                                <div class="emailaddress-info">
                                                        <div class="personal-info-head marg-btm-20">
                                                                ...
                                                                <span class="info-link" id="einfo-edit">
                                                                        <button class="btn edit-btn-new btn-xs">
                                                                                <i class="fa fa-pencil"></i>
                                                                                <span>Email</span>
                                                                        </button>
                                                                </span>
                                                                <span class="info-link" id="einfo-cancel">
                                                                        <button class="btn cancel-btn-new btn-xs">
                                                                                <span>Cancel</span>
                                                                        </button>
                                                                </span>
                                                                <span class="info-link" id="einfo-changepass">
                                                                        <button class="btn edit-btn-new btn-xs">
                                                                                <i class="fa fa-key"></i>
                                                                                <span>Password</span>
                                                                        </button>
