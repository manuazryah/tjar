            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <div class="MyAccount-content">
                    ...
                    <div id="divAnim">
                        ...
                        <button type="button" id="btAnimate"><?= $error_return == 2 ? 'UPDATE ADDRESS' : '<span>+</span>  ADD A NEW ADDRESS' ?></button>
                        ...
                        <?php foreach ($user_address as $value) { ?>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 address">
                                <div class="option-space">
                                    <b><span><?= $value->first_name . ' ' . $value->last_name ?></span><span class="number">8907366563</span></b>
