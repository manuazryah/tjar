...
//            return $this->render('my_order', ['orders' => $orders]);
        ...
        public function actionAddReview() {
                ...
                if (Yii::$app->request->isAjax) {
                        ...
                        $exists = \common\models\CustomerReviews::find()->where(['user_id' => \Yii::$app->user->identity->id, 'product_id' => $product_id, 'order_id' => $order_id])->exists();
                        if ($exists) {
                                $model_review = \common\models\CustomerReviews::find()->where(['user_id' => \Yii::$app->user->identity->id, 'product_id' => $product_id, 'order_id' => $order_id])->one();
                        } else {
        ...
        public function actionSaveReview() {
                ...
                if (Yii::$app->request->isAjax) {
                        ...
                        $exists = \common\models\CustomerReviews::find()->where(['user_id' => \Yii::$app->user->identity->id, 'product_id' => $_POST['CustomerReviews']['product_id'], 'order_id' => $_POST['CustomerReviews']['order_id']])->exists();
                        if ($exists) {
                                $model_review = \common\models\CustomerReviews::find()->where(['user_id' => \Yii::$app->user->identity->id, 'product_id' => $_POST['CustomerReviews']['product_id'], 'order_id' => $_POST['CustomerReviews']['order_id']])->one();
                        } else {
                                $model_review = new \common\models\CustomerReviews();
                        }
