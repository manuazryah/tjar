<div class="content" style="background: #f5f2f2;margin: 25px 80px;">
        <div class="header-content" style="background: #03A9F4;padding: 15px 30px;color: white;text-transform: uppercase;    font-weight: 600;">Tjar Verification Code</div>
        <div style="padding: 15px 30px;background: #f9f9f9;">
                ...
                <p style="text-align: center;font-weight: 600;"><?= $val ?></p>
