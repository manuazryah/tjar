				...
				<div class='col-md-12' style="padding: 0px">
					...
					<div class="carousel slide media-carousel" id="media">
						<div class="carousel-inner">
							...
							$product_datas = common\models\ProductVendor::find()->where(['vendor_status' => 1])->andWhere(['in', 'id', $prod_data_id])->all();
							$i = 0;
			...
			<div class="container">
					...
					<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
						<div class="MultiCarousel-inner">
							...
							$product1_datas = common\models\ProductVendor::find()->where(['vendor_status' => 1])->andWhere(['in', 'id', $prod_data_idd])->all();
