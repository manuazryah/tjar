                                                                ...
                                                                foreach ($cart_items as $cart_item) {
                                                                        ...
                                                                        <tr class="cart_item tr_<?= $cart_item->id ?>">
                                                                                ...
                                                                                <td class="product-item" data-title="Product">
                                                                                        ...
                                                                                        <a class="label-href" href="<?= Yii::$app->homeUrl . 'product-detail/' . $product->canonical_name . '/' . yii::$app->EncryptDecrypt->Encrypt('encrypt', $cart_item->product_id) ?>">
                                                                                        ...
                                                                                        </a><a class="product-discrp label-href" href="<?= Yii::$app->homeUrl . 'product-detail/' . $product->canonical_name . '/' . yii::$app->EncryptDecrypt->Encrypt('encrypt', $cart_item->product_id) ?>">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                                ...
                                                                                <div class="wc-proceed-to-checkout confirm-checkout hide">
                                                                                        <div class='col-md-12'>
                                                                                                ...
                                                                                                <?php } else { ?>
                                                                                                        <?= $form1->field($order, 'payment_type')->dropDownList(['1' => 'Cash On Delivery', '2' => 'Net Banking']) ?>
