                                        ...
                                        <div class="other-options">
                                                <ul class="options">
                                                        ...
                                                        <?php } else {
                                                                ?>
                                                                <li>
                                                                        <?= Html::a(Html::encode(Wallet), ['/my-wallet']); ?>
                                                                </li>
                                                ...
                                                <ul>
                                                        ...
                                                        if (!empty($main_menus)) {
                                                                foreach ($main_menus as $main_menu) {
                                                                        ...
                                                                        ?>
                                                                        <li id="main-div"><a href="#"><?= Yii::$app->SetLanguage->ViewData($main_menu, 'main_menu'); ?><span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
