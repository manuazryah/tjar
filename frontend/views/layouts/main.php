...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <link rel="shortcut icon" href="<?= Yii::$app->homeUrl; ?>images/favicon.ico" type="image/png">
    ...
    <body>
                    ...
                    <div class="other-options">
                        <ul class="options">
                            ...
                            <?php if (empty(Yii::$app->user->identity)) { ?>
                                <li><a class="log-sign">Wallet</a></li>
                            ...
                            <?php } else {
                                ?>
                                <li>
                                    <?php $wallet = User::findOne(Yii::$app->user->identity->id) ?>
                                    <?= Html::a(Html::encode('Wallet (' . $wallet->wallet_amount . ')'), ['/my-wallet']); ?>
                                </li>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 inputGroupContainer">
                                                <div class="input-group">
                                                    <input  id="user-email" name="LoginForm[username]" placeholder="Enter Email/Mobile number" class="form-control" type="text">
                                    ...
                                    <fieldset id="forgot-datas">
                                        <div id="forgot-entry">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 inputGroupContainer">
                                                    <div class="input-group">
                                                        <input  id="forgot-email" name="forgot_email" placeholder="Enter Email/Mobile number" class="form-control" type="text">
                                                        <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                                    </div>
                                                    <!--<div class="error-block">This field is required</div>-->
                                                </div>
            ...
            <div class="top-header-2">
                <div class="container">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-4 cart">
                        <a href="<?= Yii::$app->homeUrl; ?>cart/mycart"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>CART</span></a><label class="cart_count"><?= $cart_count ?></label>
                        <!--<div class="container">-->
                        <div class="shopping-cart">
                            ...
                            -->                            <div class="col-md-12 checkout-btn-space">
                                <?= Html::a('<button class="green2">check out</button>', ['/cart/mycart'], ['class' => '', 'style' => 'background:#fff']) ?>
                        ...
                        <ul>
                            ...
                            if (!empty($main_menus)) {
                                foreach ($main_menus as $main_menu) {
                                    ...
                                    ?>
                                    <li id="main-div"><a href="javascript:void(0)"><?= Yii::$app->SetLanguage->ViewData($main_menu, 'main_menu'); ?><span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                        <?php if (!empty($submenus)) { ?>
                                            <ul class="list">
                                                ...
                                                foreach ($submenus as $submenu) {
                                                    ...
                                                    <li><a href="<?= $submenu->sub_menu_link ?>"><?= Yii::$app->SetLanguage->ViewData($submenu, 'sub_menu'); ?></a>
                                                        <?php if (!empty($child_menus)) { ?>
                                                            <ul>
                                                                <?php
                                                                foreach ($child_menus as $child_menu) {
                                                                    ?>
                                                                    <li><a href="<?= $child_menu->child_menu_link ?>"><?= Yii::$app->SetLanguage->ViewData($child_menu, 'child_menu'); ?></a></li>
                                                                <?php }
                                                                ?>
                                                            </ul>
                                                            <?php
        ...
        <div class="page-loading-overlay loaded">
            ...
            <!--<img src="<?= yii::$app->homeUrl ?>/images/loading.gif">-->
                ...
                <div class="container">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <div class="footer-links">
                            ...
                            <ul class="address">
                                <li><span class="round-icon"><i class="fa fa-map-marker" aria-hidden="true"></i></span>Addresss: 123 Doha, Qatar</li>
