        ...
        <header>
                ...
                <div class="container">
                    <div class="dropdown">
                        ...
                        <div id="myDropdown" class="dropdown-content">
                            <ul>
                                <li><a href="#English"><span class="country-flag"><img src="images/flags/USA.png"/></span> English</a></li>
                                <li><a href="#Arabic"><span class="country-flag"><img src="images/flags/UAE.png"/></span> ARABIC</a></li>
                            </ul>
                        </div>
                    </div>
                    <!--                    <div class="language">
            ...
            <div class="nav-header">
                <div class="menu-container">
                    <div class="menu">
                        <ul>
                            <li id="main-div"><a href="#">ELETRONICS<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                <ul class="list">
                                    <li><a href="#">Mobiles</a>
                                        <ul>
                            ...
                            <li><a href="#">Appliences<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                <ul>
                                    <li><a href="#">Televisions</a>
                                        <ul>
                                            <li><a href="#">Lidership</a></li>
                            ...
                            <li><a href="#">Men<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                <ul>
                                    <li><a href="#">Televisions</a>
                                        <ul>
                                            <li><a href="#">Lidership</a></li>
                            ...
                            <li><a href="#">Women<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                <ul>
                                    <li><a href="#">Televisions</a>
                                        <ul>
                                            <li><a href="#">Lidership</a></li>
                            ...
                            <li><a href="#">BABY & KIDS<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span> </a>
                                <ul>
                                    <li><a href="#">Televisions</a>
                                        <ul>
                                            <li><a href="#">Lidership</a></li>
                            ...
                            <li><a href="#">HOME & FURNITURE<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                <ul>
                                    <li><a href="#">Televisions</a>
                                        <ul>
                                            <li><a href="#">Lidership</a></li>
                            ...
                            <li><a href="#">BOOKS & MORE<span class="dropdown-arrow hidden-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></a>
                                <ul>
                                    <li><a href="#">Televisions</a>
                                        <ul>
                                            <li><a href="#">Lidership</a></li>
