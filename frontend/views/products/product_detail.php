                                        ...
                                        <div class="app-figure" id="zoom-fig">
                                                ...
                                                <div class="selectors">
                                                        ...
                                                        <a
                                                                ...
                                                                data-image="<?= Yii::$app->homeUrl ?>/images/products/1.png?scale.height=400"
                                                                >
                                                                <img srcset="<?= Yii::$app->homeUrl ?>/images/products/1.png?scale.width=112 2x" src="<?= Yii::$app->homeUrl ?>/images/products/3thumb.png?scale.width=56"/>
                                                        </a>
                                                        <a
                                                                data-zoom-id="Zoom-1"
                                                ...
                                                <div id="spec" class="tab-pane fade">
                                                        <table cellspacing="0" cellpadding="0" border="0">
                                                                <tbody>
                                                                        ...
                                                                        <tr><td class="label">Item Weight</td><td class="value">159 g</td></tr>
                                                                        <tr><td class="label">Product Dimensions</td><td class="value">15.3 x 0.7 x 7.5 cm</td></tr>
                                                                        <tr><td class="label">Item model number</td><td class="value">3T</td></tr>
