        ...
        if (code !== "") {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (res.result['msg'] == 6) {
                        $('.coupon-code-error').html('In order to avail the benefits of this promotional code, please Login/Sign Up.');
...
//                        $("#coupon_code").after('<div class="help-block" style="color:red">Invalid Code! Please try another one.</div>');
                        ...
                        $('.coupon-code-error').html('This code is only when purchase items above AED  ' + res.result['amount']);
...
//                        $("#coupon_code").after('<div class="help-block" style="color:red">Sorry!! You are already used this code!</div>');
                        ...
                        $('.coupon-code-error').html('You can use only one coupon code');
//                        $("#coupon_code").after('<div class="help-block" style="color:red">You can use only one coupon code</div>');
            ...
            $('.coupon-code-error').html('Enter a valid code');
        }
