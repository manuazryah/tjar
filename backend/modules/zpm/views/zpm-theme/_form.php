...
<script>
    $("#zpmtheme-main_category").select2({
...
<script>
    $(document).ready(function () {
        $('#zpmtheme-value').keyup(function () {
            $('#zpmtheme-canonical_name').val(slug($(this).val()));
        });
