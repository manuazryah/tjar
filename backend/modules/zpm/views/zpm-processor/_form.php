...
<script>
    $("#zpmprocessor-main_category").select2({
    ...
    $("#zpmprocessor-subcategory").select2({
...
<script>
    $(document).ready(function () {
        $('#zpmprocessor-value').keyup(function () {
            $('#zpmprocessor-canonical_name').val(slug($(this).val()));
        });
