...
<div class="zpm-pattern-form form-inline">
...
<script>
    $("#zpmpattern-main_category").select2({
    ...
    $("#zpmpattern-subcategory").select2({
...
<script>
    $(document).ready(function () {
        $('#zpmpattern-value').keyup(function () {
            $('#zpmpattern-canonical_name').val(slug($(this).val()));
        });
