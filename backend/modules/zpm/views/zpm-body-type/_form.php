...
<div class="zpm-body-type-form form-inline">
    ...
    <div class='col-md-6 col-sm-6 col-xs-12 left_padd'>   
        ...
        echo $form->field($model, 'subcategory')->widget(DepDrop::classname(), [
            ...
            'pluginOptions' => [
                'depends' => ['zpmbodytype-main_category', 'zpmbodytype-category'],
                'placeholder' => 'Select...',
