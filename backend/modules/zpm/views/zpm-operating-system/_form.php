...
<script>
    $("#zpmoperatingsystem-main_category").select2({
    ...
    $("#zpmoperatingsystem-category").select2({
    ...
    $("#zpmoperatingsystem-subcategory").select2({
...
<script>
    $(document).ready(function () {
        $('#zpmoperatingsystem-value').keyup(function () {
            $('#zpmoperatingsystem-canonical_name').val(slug($(this).val()));
        });
