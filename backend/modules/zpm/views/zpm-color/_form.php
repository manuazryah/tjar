...
<div class="zpm-color-form form-inline">
...
<script>
    $("#zpmcolor-main_category").select2({
...
<script>
    $(document).ready(function () {
        $('#zpmcolor-value').keyup(function () {
            $('#zpmcolor-canonical_name').val(slug($(this).val()));
        });
