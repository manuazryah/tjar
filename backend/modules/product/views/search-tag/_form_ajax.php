            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ($data.con === "1") {
                        ...
                        $('#product-search_tags').append(newOption);
                        $('#product-search_tags' + ' option[value=' + $data.id + ']').attr("selected", "selected");
                        var vals = $('#product-search_tags').val();

                        $('#product-search_tags').select2('val', vals);
                        $('#product-search_tags').append($('<option value="' + $data.id + '" selected="selected" >' + $data.tag + '</option>'));
                        //$('#s2id_product-search_tags').select2('data', vals;
//
