...
//							'product_name',
                                                        [
                                                            ...
                                                            'filter' => Html::activeDropDownList($searchModel, 'main_category', ArrayHelper::map(ProductMainCategory::find()->where(['status' => 1])->all(), 'id', 'name'), ['class' => 'form-control', 'id' => 'product_category', 'prompt' => '']),
                                                            'value' => 'mainCategory.name'
                                                        ],
                                                            [
                                                            'attribute' => 'category',
                                                            'filter' => Html::activeDropDownList($searchModel, 'category', ArrayHelper::map(ProductCategory::find()->where(['status' => 1])->all(), 'id', 'category_name'), ['class' => 'form-control', 'id' => 'product_cat_category', 'prompt' => '']),
