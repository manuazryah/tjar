        ...
        <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab1">
                        <div class="product-main-form">
                                ...
                                <div class='col-md-6 col-sm-12 col-xs-12 left_padd'>
                                        <?= $form->field($model, 'short_description_arabic')->textarea(['rows' => 4]) ?>
                                </div>
                                ...
                                <div class='col-md-6 col-sm-12 col-xs-12 left_padd'>
                                        <?= $form->field($model, 'important_notes')->textarea(['rows' => 4]) ?>
                                </div>
                                <div class='col-md-6 col-sm-12 col-xs-12 left_padd'>
                                        <?= $form->field($model, 'important_notes_arabic')->textarea(['rows' => 4]) ?>
                                </div>
                                ...
                                <div class='col-md-6 col-sm-6 col-xs-12 left_padd'>
                                        <?= $form->field($model, 'gender')->dropDownList(['' => '--Select--', '1' => 'Male', '2' => 'Female']) ?>
                                ...
                                <div class='col-md-6 col-sm-6 col-xs-12 left_padd'>
                                        <?= $form->field($model, 'commisson')->textInput(['maxlength' => true])->label('Commisson (%)') ?>
                                ...
                                ?>
                                <input type="hidden" name="model-id"id="model-id" value="<?= $model_id ?>">
                        ...
                        if ($model->isNewRecord) {
                                ...
                                $btn_id = 'btnNextUpdate';
                                $btn_class = '';
                        }
                        ?>
                        <div class='col-md-12 col-sm-12 col-xs-12 left_padd' style="padding-top: 45px;">
                                <a class="btn btn-primary next-btn <?= $btn_class ?>" id="<?= $btn_id ?>">Next</a>
...
<script>
        $(document).ready(function () {
                ...
                $('#btnNext').click(function () {
                        ...
                        var modelId = $('#model-id').val();
                        subcategoryAlert(sub_category_id, modelId, category_id);
                        var radio_btn = $('input[name="profile-image"]:checked').attr("id-for");
                        setProfilePic(radio_btn);

                        if ($('#btnNext.btnnxtcls').length > 0) {
                                SetSpecification();
                        }
//			product_features(sub_category_id, category_id);
                });
        ...
        function subcategoryAlert(sub_category_id, modelId, category_id) {
...
//
//			$('.field-products-subcategory .help-block').hide("");
//			if ($(".error").text() === "") {
//
//				$(".field-products-subcategory").append("<div class='error'>Subcategory cannot be blank.</div>");
//
//			}
//		}
...
<script type="text/javascript">
        CKEDITOR.replace('products-highlights',
                {
                        toolbar: 'Basic', /* this does the magic */
                        height: '200px',

                });
        CKEDITOR.replace('products-highlights_arabic',
                {
                        toolbar: 'Basic', /* this does the magic */
                        height: '200px',
