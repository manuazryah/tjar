	...
	<div class="panel panel-default">
		<div class="panel-heading" style="border-bottom: none;">
			...
			<div style="float:left;padding-top: 13px;">
				...
				<?php } ?>
				<?= Html::a('<i class="fa fa-history manage"><span class="tooltiptext" style="width: 105px;">Product History</span></i>', ['product-history', 'id' => $model->id], ['class' => 'btn btn-icon product_venode_view_btns', 'style' => 'float:right;']) ?>
				<?php // Html::a('<i class="fa fa-thumbs-down manage"><span class="tooltiptext" style="width: 105px;">Complaints</span></i>', ['value' => Url::to(['product-complaints', 'id' => $model->id]), 'class' => 'btn btn-icon btn-red']); ?>
				<?= Html::a('<i class="fa fa-thumbs-down manage"><span class="tooltiptext" style="width: 105px;">Complaints</span></i>', ['product-complaints', 'id' => $model->id], ['class' => 'btn btn-icon btn-red modalButton']) ?>
			</div>
