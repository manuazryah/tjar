...
$limit_notifications = NotificationViewStatus::find()->where(['user_type' => 1, 'user_id' => Yii::$app->user->identity->id, 'view_status' => 0])->limit(3)->orderBy(['id' => SORT_DESC])->all();
?>
                                        ...
                                        <ul id="main-menu" class="main-menu">
                                                ...
                                                <?php if (Yii::$app->session['post']['admin'] == 1) { ?>
                                                        <li>
                                                                ...
                                                                <ul>
                                                                        ...
                                                                        <li>
                                                                                <?= Html::a('Orders', ['/orders/order-master/full-fill'], ['class' => 'title']) ?>
                                                                        </li>
                                                ...
                                                <?php if (Yii::$app->session['post']['users'] == 1) { ?>
                                                        <li>
                                                                ...
                                                                <ul>
                                                                        ...
                                                                        <li>
                                                                                <?= Html::a('Recent Wallet Activity', ['/user/user-wallet/recent-activity'], ['class' => 'title']) ?>
                                                                        </li>
                                                                </ul>
                                                        </li>
                                                <?php } ?>
                                                ...
                                                <?php if (Yii::$app->session['post']['admin'] == 1) { ?>
                                                        <li>
                                                                ...
                                                                <ul>
                                                                        <li>
                                                                                <?= Html::a('Commission', ['/commissionmanagement/commission-management/index'], ['class' => 'title']) ?>
                                                                        </li>
                                                                </ul>
                                                        </li>
                                                <?php } ?>
                                                <?php if (Yii::$app->session['post']['admin'] == 1) { ?>
                                                        <li>
                                                                ...
                                                                <ul>
                                                                        ...
                                                                        <li>
                                                                                <?= Html::a('Stock report', ['/reports/stock-history/index'], ['class' => 'title']) ?>
                                                                        </li>
                                                                </ul>
                                                        </li>
                                                <?php } ?>
                                                ...
                                                <li class="dropdown user-profile">
                                                        ...
                                                        <ul class="dropdown-menu user-profile-menu list-unstyled">
                                                                ...
                                                                <li class="user-footer" style="background: #eeeeee;">
                                                                        <div class="row">
                                                                                <div class="pull-left">
                                                                                        <?= Html::a('Profile', ['/admin/admin-users/update?id=' . Yii::$app->user->identity->id], ['class' => 'btn btn-white', 'style' => 'padding: 13px 20px;']) ?>
                                                                                </div>
